...
export default function AtividadeEditForm({ tipo, atividade, projetos, onSuccess, onCancel }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await base44.entities[tipo].update(atividade.id, formData);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        {formData.comprovacao_urls && formData.comprovacao_urls.length > 0 && (
