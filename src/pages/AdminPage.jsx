...
Seja detalhado, prático e objetivo na análise.`;
  ...
  const renderDiscentesTab = () => (
    <div>
      ...
      {showDiscenteForm && (
        <DiscenteForm
          discenteForm={discenteForm}
          setDiscenteForm={setDiscenteForm}
          editingDiscente={editingDiscente}
          onSave={handleSaveDiscente}
          onCancel={resetDiscenteForm}
          uploadingFotoDiscente={uploadingFotoDiscente}
          onUploadFoto={handleUploadFotoDiscente}
          especializacoes={especializacoes}
          parceiros={parceiros}
          handleDiscenteEspecCheckboxChange={handleDiscenteEspecCheckboxChange}
          handleDiscenteParceiroCheckboxChange={handleDiscenteParceiroCheckboxChange}
        />
      )}
