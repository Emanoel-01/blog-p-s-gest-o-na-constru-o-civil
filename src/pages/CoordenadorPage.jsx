...
export default function CoordenadorPage() {
  ...
  const timeline = [
    ...
    { year: '2024', title: 'Mestrado em Engenharia Civil', description: 'Gestão da Manutenção de Edificações em Instituições Públicas. UPE - Universidade de Pernambuco. Orientador: Prof. Dr. Alberto Casado Lordsleem Júnior.', icon: 'academic' },
