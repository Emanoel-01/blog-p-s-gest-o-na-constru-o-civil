...
const DISCIPLINE_DATA = {
  comum: [
    ...
    { name: 'Novas Fontes de Receita: Elaboração de Laudos e Perícias', type: 'EAD' },
    { name: 'Solução Criativa de Problemas Complexos (Design Thinking)', type: 'EAD' },
    { name: 'Negociação e Gestão de Conflitos', type: 'EAD' },
    { name: 'Competências Estratégicas, Liderança e Alta Performance', type: 'EAD' },
    { name: 'Metodologia da Pesquisa e Didática do Ensino Superior', type: 'EAD' },
  ],
  especifica_gestao: [
